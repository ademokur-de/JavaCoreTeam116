...
public class C02_LocalDate {
    public static void main(String[] args) {
        ...
        LocalDate dogumTarihiHayrttn= LocalDate.of(2006,8,30);
        System.out.println("Hayrettin Dogdugu gun : " + dogumTarihiHayrttn.getDayOfWeek()); // WEDNESDAY

        LocalDate dogumTarihiFrdv= LocalDate.of(1981,1,28);
        System.out.println("Frdv Dogdugu gun : " + dogumTarihiFrdv.getDayOfWeek()); // WEDNESDAY
